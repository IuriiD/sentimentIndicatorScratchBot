(function (ext) {
    ...
    ext.get_temp = function (userInput, callback) {
        console.log('LOADED!');
        ...
        $.ajax({
            ...
            success: function (sentiment_data) {                
                // Got the data - parse it and return sentimentScore and sentimentMagnitude in format '+0.4|+0.3'
                ...
                console.log('sentimentScore, sentimentMagnitude = ', response);
                callback(response);
            }
        });
    };
    ...
    var descriptor = {
        blocks: [
            ['R', 'users_input %s', 'get_temp', 'what a nice day'],
        ]
    };
